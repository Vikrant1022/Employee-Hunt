...
<html lang="en">
    ...
    <nav class="navbar navbar-default" style="margin-bottom: 0; height: 80px; background-color: white; border-color: transparent;">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          <a class="navbar-brand" style="font-size: 24px; color: #053a5a; line-height: 42px;" href="index.php">EmployeeHunt</a>
        </div>
  ...
  <section>
    <div class="container">
      <div class="row">
        ...
        $sql = "SELECT * FROM job_post ORDER BY id_jobpost DESC limit 10";
  ...
  <footer id="footer" style="background-color: #053a5a; height: 80px;">
    ...
    <p style="color:white; font-size: 20px; line-height: 80px; text-align: center;"> 
      Copyright &copy; 2021-2022 <a href="index.php" style="color:white;">EmployeeHunt </a>
    </p>
